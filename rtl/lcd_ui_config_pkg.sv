...
package lcd_ui_config_pkg;
    ...
    localparam LCD_UI_BITMAP_ID_WIDTH = 8;
    ...
    typedef logic[LCD_UI_BITMAP_ID_WIDTH - 1:0] lcd_ui_bitmap_id_t;
    ...
    localparam lcd_ui_config_type_t LCD_UI_CONFIG_TYPE_DRAW_BITMAP = LCD_UI_CONFIG_TYPE_WIDTH'('h02);
    ...
    typedef struct packed
    {
        lcd_ui_x_t x;
        lcd_ui_y_t y;
        lcd_ui_bitmap_id_t bitmap_id;
        lcd_ui_color_t color;
    }lcd_ui_draw_bitmap_config_t;
    ...
    localparam LCD_UI_DRAW_BITMAP_CONFIG_WIDTH = $bits(lcd_ui_draw_bitmap_config_t);
    ...
    function automatic lcd_ui_config_data_t make_draw_bitmap_config(
            input lcd_ui_x_t x,
            input lcd_ui_y_t y,
        ...
        lcd_ui_config_payload_t config_payload;
        lcd_ui_draw_bitmap_config_t draw_bitmap_config;

        begin
            config_payload = '0;
            draw_bitmap_config = '0;
            draw_bitmap_config.x = x;
            draw_bitmap_config.y = y;
            draw_bitmap_config.bitmap_id = bitmap_id;
            draw_bitmap_config.color = color;
            config_payload[LCD_UI_DRAW_BITMAP_CONFIG_WIDTH - 1:0] = draw_bitmap_config;
            make_draw_bitmap_config = make_config(LCD_UI_CONFIG_TYPE_DRAW_BITMAP, config_payload);
        end
    endfunction
